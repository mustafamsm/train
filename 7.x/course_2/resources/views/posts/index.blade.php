                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            &nbsp;&nbsp;
                            <a href="{{route('posts.edit',['id'=> $item->id])}}"> <i class="fas fa-2x fa-edit"></i>  </a>&nbsp;&nbsp;
                            <a class="text-danger" href="{{route('posts.delete',['id'=> $item->id])}}"> <i class="fas  fa-2x fa-trash-alt"></i> </a>
                            @endif
